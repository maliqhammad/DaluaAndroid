...
import com.dalua.app.databinding.ItemPublicSchedulesBinding
...
class PublicScheduleAdapter(
    val viewModel: PublicScheduleVM,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        when (viewType) {
            ITEM -> {
                val binding: ItemPublicSchedulesBinding = DataBindingUtil.inflate(
                    LayoutInflater.from(parent.context),
                    R.layout.item_public_schedules, parent, false
                )
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        Log.d("TAG", "onBindViewHolder: " + daluaList.size)
    ...
    fun addScheduleList(daluaList: MutableList<SingleSchedule>) {
        this.daluaList = daluaList
...
//        chart.animateX(1500, Easing.EaseInSine)
    ...
    class MyViewHolder(val binding: ItemPublicSchedulesBinding) : RecyclerView.ViewHolder(binding.root)
