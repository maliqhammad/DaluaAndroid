...
open class ImagePicker {
    ...
    companion object {
        ...
        internal const val EXTRA_BURST_MODE = "extra.burst_mode"
    ...
    class Builder(private val activity: Activity) {
        ...
        /**
         * it captures multiple images by staying on camera screen
         */
        fun burstMode(isBurstMode: Boolean): Builder {
            this.burstMode = isBurstMode
            return this
        }
        ...
        private fun getBundle(): Bundle {
            return Bundle().apply {
                ...
                putBoolean(EXTRA_BURST_MODE, burstMode)
