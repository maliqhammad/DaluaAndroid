...
class ImagePickerActivity : AppCompatActivity() {
    ...
    private fun loadBundle(savedInstanceState: Bundle?) {
        ...
        //Retrieve burst mode
        burstMode = intent?.getBooleanExtra(ImagePicker.EXTRA_BURST_MODE, false)!!
        ...
        when (provider) {
            ...
            ImageProvider.CAMERA -> {
                ...
                // Pick Camera Image
                savedInstanceState ?: mCameraProvider?.startIntent(burstMode)
            }
            else -> {
    ...
    override fun onRequestPermissionsResult(
        ...
        mCameraProvider?.onRequestPermissionsResult(requestCode,burstMode)
    }
    ...
    private fun setResult(uri: Uri) {
        ...
        if (burstMode) {
            Log.d(TAG, "setResult: do something here... $burstMode")
        } else {
            finish()
            Log.d(TAG, "setResult: burstMode: $burstMode")
        }
    }
